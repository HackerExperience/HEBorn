...
update data msg model =
    case msg of
        ...
        ReqBankLogin bank login password ->
            onReqBankLogin data bank login password model.me model

        ReqBankTransfer fromBank fromAcc toBank toAcc password value ->
            onReqBankTransfer data fromBank fromAcc toBank toAcc password value model.me model
...
onReqBankLogin :
    ...
    -> Model
    -> UpdateResponse
onReqBankLogin data bank login password { sessionId, windowId, context } model =
    let
        cid =
            data
                |> Game.getActiveCId
...
onReqBankTransfer :
    ...
    -> Model
    -> UpdateResponse
onReqBankTransfer data fromBank fromAcc toBank toAcc password value { sessionId, windowId, context } model =
    let
        cid =
            data
                |> Game.getActiveCId
