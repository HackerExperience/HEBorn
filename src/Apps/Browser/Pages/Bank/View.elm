...
submitLoginAttr : Config msg -> Model -> Attribute msg
...
submitTransferAttr : Config msg -> Model -> Attribute msg
    ...
    in
        ...
        of
            ( Just fromAccount, Just toBank, Just toAccount, Just password, Just value ) ->
                [ onSubmit <| onTransfer fromAccount toBank toAccount password value ]
                    |> flip (++) baseAttr
