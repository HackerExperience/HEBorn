    ...
    let
        ...
        reducer id acc acu =
            Html.option
                ...
                |> flip (::) acu
    in
        Dict.foldr reducer [] (Finances.getBankAccounts finances)
            |> Html.select []
    ...
    let
        ...
        reducer address _ acu =
            Html.option
                ...
                |> flip (::) acu
    in
        Dict.foldr reducer [] (Finances.getBitcoinWallets finances)
            |> Html.select []
