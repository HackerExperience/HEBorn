...
type alias RequestStore = Dict.Dict RequestID RequestStoreData
...
type alias ResponseDecoder = RequestID -> Int ->  Response
...
initialModel seedInt =
    let
        (uuid, seed) = step Uuid.uuidGenerator (initialSeed seedInt)
    in
